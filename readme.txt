...
To run the simulation and generate the visuals yourself, you will need Python and a few dependencies.
	...
	This will reproduce the visuals from the manuscript.
